...
import { CustomDropdown, Decimal, Spinner, CustomIcon } from "src/components";
      ...
      <S.Wrapper>
        <S.Header>
          ...
          <S.Options>
            <ul>
              <li>
                <CustomIcon icon="OrdersBuy" size="xsmall"/>
              </li>
              <li>
                <CustomIcon icon="OrdersAll" size="xsmall"/>
              </li>
              <li>
                <CustomIcon icon="OrdersSell" size="xsmall"/>
              </li>
            </ul>
  ...
  private orderBook = (bids, asks, isLarge: boolean, formattedBaseUnit, formattedQuoteUnit) => {
    ...
    return (
      <OrderbookTable 
        ...
        rowBackgroundColorAsks={defaultThemes.dark.colors.gradientRed}
        rowBackgroundColorBids={defaultThemes.dark.colors.gradientGreen}
