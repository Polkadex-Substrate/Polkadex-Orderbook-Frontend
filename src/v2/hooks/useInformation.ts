...
export function useInformation() {
  ...
  return {
    ...
    lastPrice: Decimal.format(getTickerValue("last"), currentMarket?.quote_precision, ","),
    volume24h: Decimal.format(getTickerValue("volume"), currentMarket?.quote_precision, ","),
    priceHigh: Decimal.format(getTickerValue("high"), currentMarket?.quote_precision, ","),
    priceLow: Decimal.format(getTickerValue("low"), currentMarket?.quote_precision, ","),
