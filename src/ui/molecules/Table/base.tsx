...
const TableColumnBase = TableColumn as <T>(props: SpectrumColumnProps<T>) => JSX.Element;

type HeaderBaseProps<T> = HeaderCustomProps & TableHeaderProps<T>;

const TableHeaderBase = TableHeader as <T>(props: HeaderBaseProps<T>) => JSX.Element;
