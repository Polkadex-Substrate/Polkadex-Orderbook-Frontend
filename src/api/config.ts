export const defaultConfig: Config = {
  api: {
    authUrl: `${process.env.HOST_URL}/api/v2/barong`,
    tradeUrl: `${process.env.HOST_URL}/api/v2/peatio`,
    applogicUrl: `${process.env.HOST_URL}/api/v2/applogic`,
...
Cryptobase.config = { ...defaultConfig };
