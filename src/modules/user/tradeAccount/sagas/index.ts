...
import { removeProxyAccountFromChain } from "./removeTradeAccountFromChain";
...
export function* rootTradeAccountsSaga() {
  ...
  yield takeLeading(USER_TRADE_ACCOUNT_REMOVE_FROM_CHAIN_DATA, removeProxyAccountFromChain);
}
