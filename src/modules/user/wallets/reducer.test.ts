...
describe("walletsList reducer", () => {
  ...
  it("should handle WALLETS_ERROR", () => {
    ...
    expect(walletsReducer(initialWalletsState, actions.walletsError(error))).toEqual(
      expectedState
    );
  });
  ...
  it("should handle WALLETS_ADDRESS_DATA", () => {
    ...
    expect(
      walletsReducer(initialState, actions.walletsAddressData(addressDataPayload))
    ).toEqual(expectedState);
  });
  ...
  it("should handle WALLETS_WITHDRAW_CCY_FETCH", () => {
    ...
    expect(
      walletsReducer(
        initialWalletsState,
        actions.walletsWithdrawCcyFetch(withdrawCcyFetchPayload)
      )
    ).toEqual(expectedState);
  });
  ...
  it("should handle WALLETS_WITHDRAW_CCY_ERROR", () => {
    ...
    expect(
      walletsReducer(initialWalletsState, actions.walletsWithdrawCcyError(error))
    ).toEqual(expectedState);
  });
});
