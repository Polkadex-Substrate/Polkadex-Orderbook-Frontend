...
export const DEPTH_EMPTY_SNAP = "depth/EMPTY_SNAP";
export const DEPTH_INCREMENT_EMPTY_SNAP = "depth/INCREMENT_EMPTY_SNAP";
export const DEPTH_INCREMENT_SUBSCRIBE_RESET_LOADING =
  "depth/INCREMENT_SUBSCRIBE_RESET_LOADING";
