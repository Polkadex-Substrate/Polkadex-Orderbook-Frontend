...
export const rangerConnectFetch = (
  payload: RangerConnectFetch["payload"]
): RangerConnectFetch => ({
...
export const rangerConnectError = (
  payload: CommonError
): RangerConnectError => ({
...
export const rangerSubscribe = (
  payload: RangerSubscribe["payload"]
): RangerDirectMessage => ({
  type: RANGER_DIRECT_WRITE,
  payload: { event: "subscribe", streams: payload.channels },
});

export const rangerUnsubscribe = (
  payload: RangerSubscribe["payload"]
): RangerDirectMessage => ({
  type: RANGER_DIRECT_WRITE,
...
export const rangerUserOrderUpdate = (
  payload: UserOrderUpdate["payload"]
): UserOrderUpdate => ({
