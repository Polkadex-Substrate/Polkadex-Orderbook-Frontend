...
const initRanger = (
  ...
  const channel = eventChannel((emitter) => {
    ...
    ws.onmessage = ({ data }) => {
      ...
      //         const previousSequence = selectOrderBookSequence(
      //           store.getState()
      //         );
      //         if (previousSequence === null) {
      //           window.console.log(
      //             "OrderBook increment received before snapshot"
      //           );
      ...
      //           case "unsubscribed":
      //             emitter(
      //               subscriptionsUpdate({ subscriptions: event.streams })
      //             );
      ...
      //                 orders.length &&
      //                 orders.find(
      //                   (order) => event.uuid && order.uuid === event.uuid
      //                 );
      //               if (!updatedOrder) {
      //                 emitter(
      //                   alertPush({
      ...
      //       case "balances":
      //         emitter(
      //           updateP2PWalletsDataByRanger({ ws: true, balances: event })
      //         );
      ...
      //       // public
      //       case "p2p.event":
      //         const p2pPublicOffersMatch =
      //           event && String(event.event).includes("p2p_offer");
      ...
      //       // private
      //       case "p2p":
      //         const p2pOrdersMatch =
      //           event && String(event.event).includes("p2p_order");
