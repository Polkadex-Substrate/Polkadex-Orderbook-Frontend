            ...
            case 10: {
              switch (methodId) {
                ...
                case 30: {
                  ...
                  this.frameMax =
                    this.frameMax === 0 ? frameMax : Math.min(this.frameMax, frameMax);
                  this.heartbeat =
                    this.heartbeat === 0 ? 0 : Math.min(this.heartbeat, heartbeat);
            ...
            case 60: {
              switch (methodId) {
                ...
                case 30: {
                  ...
                  if (consumer) {
                    consumer.setClosed(
                      new AMQPError("Consumer cancelled by the server", this)
                    );
