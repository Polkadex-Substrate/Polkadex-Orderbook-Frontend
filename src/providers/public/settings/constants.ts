...
export const SETTINGS_CHANGE_LANGUAGE = "Settings Provider/SETTINGS_CHANGE_LANGUAGE";
export const SETTINGS_CHANGE_CURRENCY = "Settings Provider/SETTINGS_CHANGE_CURRENCY";
...
export const NOTIFICATION_DELETE_ALL = "Settings Provider/NOTIFICATION_DELETE_ALL";
