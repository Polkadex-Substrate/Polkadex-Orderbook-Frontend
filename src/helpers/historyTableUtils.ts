...
export const setDepositStatusColor = (status: string): string =>
  depositColorMapping[status];

export const setWithdrawStatusColor = (status: string): string =>
  withdrawColorMapping[status];

export const setTradesType = (type: string) =>
  tradesColorMapping[type] || { color: "", text: "" };

export const setTransferStatusColor = (status: string): string =>
  transferColorMapping[status];

export const setOfferStatusColor = (status: string): string =>
  offersColorMapping[status];

export const setStateType = (status: string) =>
  stateColorMapping[status] || { color: "", text: "" };
