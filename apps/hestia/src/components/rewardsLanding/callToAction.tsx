...
export const CallToAction = () => {
  return (
    <div className="relative max-lg:flex-col flex items-center justify-between lg:gap-8 max-md:px-4 pl-10 border border-primary rounded-md my-10 overflow-hidden">
      <div className="flex flex-col gap-5 flex-1 max-w-[350px] max-lg:py-10 max-lg:text-center max-lg:items-center">
      ...
      <Image
        ...
        className="flex-1 lg:border-[1px] border-primary max-lg:max-w-[600px] lg:max-w-[700px] lg:mt-10"
      />
    </div>
  );
};
