...
import { Tokens, Table as PolkadexTable, Typography } from "@polkadex/ux";
...
export const TradesTable = forwardRef<HTMLDivElement, { maxHeight: string }>(
  ({ maxHeight }, ref) => {
                      ...
                      <PolkadexTable.Row key={value.id} {...responsiveProps}>
                        ...
                        <PolkadexTable.Cell>
                          <div className="flex items-center gap-2">
                            ...
                            <Typography.Text appearance="success" size="sm">
